...
//         let productNameInBag = shoppingBag[i].product;
//         let quantityProductInBag = shoppingBag[i].quantity;
//         let productPrice = groceries[productNameInBag].price;
//         let productDiscont = groceries[productNameInBag].discount;
//         let productSum = (quantityProductInBag * productPrice) / 100 * (100 - productDiscont);
//         totalSum += productSum;
//     }
